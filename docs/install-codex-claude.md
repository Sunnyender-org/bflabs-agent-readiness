...
unzip geo-optimize-0.4.5.zip -d .agents/skills
```
...
```bash
python3 -m venv .venv
.venv/bin/python -m pip install bflabs_agent_readiness-0.4.5-py3-none-any.whl
...
unzip geo-optimize-0.4.5.zip -d .claude/skills
```

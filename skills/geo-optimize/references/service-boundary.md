# Free Skill And Full Delivery Boundary

The open Skill proves and repairs repository-local readiness. Escalate only when the remaining work needs capabilities outside that boundary.

| Open Skill | Full delivery category |
|---|---|

...
1. 输入网站地址，查看当前问题和对应证据。
2. 复制诊断结果生成的改站提示词。
3. 把提示词和网站仓库交给你自己的 Agent。
4. 你确认修改范围后，Agent 才开始改代码和运行检查。
5. 由你决定何时部署。
6. 部署后再次检查，对比优化前后的公开网站。
...
每次只选择最适合当前问题的一种能力，避免把网站一次改乱。

## 免费自助与 BFLabs 服务

免费自助包括网站诊断、可复制的 Agent 提示词、六种开放能力和部署后复测。

BFLabs 完整服务包括真实多平台抽样、跨系统实施、持续验证，以及在客户授权后连接线索、转化和收入结果。
